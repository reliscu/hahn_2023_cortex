...
# Didn't get all the samples the first time! Getting missing samples:

conda activate star

cd /mnt/lareaulab/reliscu/no_backup/NSF_GRFP/data/bulk/hahn_2023/cortex/trimmed/new
...
#         --readFilesIn "${ea}/${ea}_val_1.fq.gz" "${ea}/${ea}_val_2.fq.gz" \
#         --outSAMtype BAM SortedByCoordinate \
#         --outFileNamePrefix "../../processed/STAR/new/${ea}/" \
#         --twopassMode Basic \
#         --quantMode GeneCounts \
#         --outFilterMultimapNmax 20 \
#         --alignSJDBoverhangMin 1 \
